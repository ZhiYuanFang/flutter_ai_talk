...
- **iOS**：源码位于 `ios/PangbaoWidget/`；GitHub Actions 自动添加 Extension target、为 Extension CocoaPods 链接 `home_widget`，并双描述文件签名（无 Mac 见 `ios/PangbaoWidget/README.md` 与 `docs/github-ios-ipa.md` App Groups 章节）。
