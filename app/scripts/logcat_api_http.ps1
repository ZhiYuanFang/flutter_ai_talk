...
# 增删 tag：修改下方 $Tags 数组
$Tags = @('[ApiHttp]', '[UcgFeed]', '[UcgLocation]', '[UcgVideo]', '[UcgCompose]', '[UcgPlay]', '[UcgUnread]', '[UcgPush]', '[UcgShare]', '[PangbaoClinic]', '[WsTransport]', '[HomeWidget]', '[CareAlert]', '[CashVip]', '[FeatureUnlock]', '[LandscapeKws]', '[LandscapeVoice]', '[GrowthTrajectory]', '[ClientUsage]', '[PredictImminent]')
